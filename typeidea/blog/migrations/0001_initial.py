# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2023-03-05 13:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('own', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='作者')),
            ],
            options={
                'verbose_name': '分类',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveIntegerField(choices=[(1, '正常'), (2, '草稿'), (0, '删除')], default=1, verbose_name='状态')),
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
